...
func main() {
  ...
  client := hbase2.NewTHBaseServiceClientFactory(trans, protocolFactory)
  ...
  case "getMultiple":
    ...
    containerStruct1 := hbase2.NewTHBaseServiceGetMultipleArgs()
  ...
  case "putMultiple":
    ...
    containerStruct1 := hbase2.NewTHBaseServicePutMultipleArgs()
  ...
  case "deleteMultiple":
    ...
    containerStruct1 := hbase2.NewTHBaseServiceDeleteMultipleArgs()
  ...
  case "increment":
    ...
    argvalue1 := hbase2.NewTIncrement()
  ...
  case "mutateRow":
    ...
    argvalue1 := hbase2.NewTRowMutations()
